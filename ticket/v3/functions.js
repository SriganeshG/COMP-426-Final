...
function ShowTickets()
{
        ...
        success : function(data) { 
          ////using HTML Table as a simple way to show, you make it better or leave it...Nothing wrong with HTML tables!
           ...
           var ticketTable = "<table class='table table-bordered table-hover table-dark'><tr><th>Submitter</th><th>Category</th><th>Priority</th><th>Subject</th><th>Department</th><th>View</th></tr>";
            for(var i = 0; i < data.length; i++)
            {
